...
// const categories = [
//   { name: "Water Soluble Fertilizers", image: shop1 },
//   { name: "Micronutrients", image: shop2 },
//   { name: "Plant Growth Promoter", image: shop3 },
//   { name: "Bio Pesticides", image: shop4 },
//   { name: "Bio Fertilizers", image: shop5 },
//   { name: "Organic Manures", image: shop6 },
// ];
...
//             {/* Category Name */}
//             <p className="mt-3 text-xs sm:text-sm font-medium whitespace-nowrap overflow-hidden text-ellipsis group-hover:text-green-600 transition">
//               {item.name}
//             </p>
//           </div>
//         ))}
