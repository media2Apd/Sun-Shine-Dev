...
// <button
// onClick={()=>removeItem(item.cartId)}   // ✅ FIXED
// className="absolute top-4 right-4 md:hidden text-gray-400 hover:text-red-500"
// >
// <X size={18}/>
// </button>
...
// <button
// onClick={()=>decreaseQty(item.cartId)}   // ✅ FIXED
// className="text-gray-600"
// >
// -
// </button>
...
// <button
// onClick={()=>increaseQty(item.cartId)}   // ✅ FIXED
// className="text-gray-600"
// >
// +
// </button>
