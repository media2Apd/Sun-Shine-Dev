...
//             <div className="font-medium">MKR-2026-100546</div>
//           </div>
...
//             <div className="font-medium">5 - 7 Oct 2026</div>
//           </div>
//         </div>
//       </div>
...
//             <span className="font-medium text-black">Order Details</span> • Dec 24, 2025 • 3 Products
//           </div>
...
//               <p className="font-medium">Daine Russell</p>
...
//                 <span className="text-gray-500">ORDER ID:</span>
//                 <span className="font-medium">MKR-2026-100546</span>
//               </div>
...
//           <button className="border rounded-full px-6 py-3 w-full md:w-auto">
//             Track Order
//           </button>

//           <button className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-full w-full md:w-auto">
//             Continue Shopping
//           </button>
//         </div>
//       </div>
