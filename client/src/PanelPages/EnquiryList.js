          ...
          <tbody>
            {filteredData.length === 0 ? (
              ...
              filteredData.map((item) => (
                ...
                <tr key={item.id} className="text-sm text-center relative">
                  ...
                  <td className="py-4 px-4 bg-white border-y border-r border-gray-200 rounded-r-lg relative">
                    ...
                    {openMenuId === item.id && (
                      <div
                        ref={menuRef}
                        className="absolute right-0 mt-2 w-32 bg-white border rounded-lg shadow-md text-sm z-50 overflow-visible"
                      >
                        <button
                          onClick={() =>
                            navigate("enquiry-overview", { state: { id: item.id } })
                          }
